...
const policyPublicPath =
  process.env.MFE_POLICY_PUBLIC_PATH ||
  (process.env.DEPLOY_PRIME_URL && `${process.env.DEPLOY_PRIME_URL}/`) ||
  (process.env.NODE_ENV === 'production' ? 'https://insurance-policy.netlify.app/' : 'http://localhost:3001/');
